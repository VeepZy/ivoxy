...
const {
    JAVASCRIPT_FILES,
} = require("@vercel/style-guide/eslint/constants");
        ...
        "import/no-restricted-paths": [
            "error",
            {
                zones: [
                    ...
                    {
                        target: "./src/features/context-data",
                        from: "./src/features",
                        except: ["./context-data"],
                    },
                    {
                        target: "./src/features/context-theme",
                        from: "./src/features",
                        except: ["./context-theme"],
                    },
                    {
                        target: "./src/featuresd/unescaped-title",
                        from: "./src/features",
                        except: ["./unescaped-title"],
                    },
                    {
                        target: "./src/features/app-sidebar",
                        from: "./src/features",
                        except: ["./app-sidebar"],
                    },
                    {
